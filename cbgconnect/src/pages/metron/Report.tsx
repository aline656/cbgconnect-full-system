...
export default function Report() {
  ...
  const reports: Report[] = [
    {
      id: '1',
      title: 'Daily Dormitory Check',
      type: 'daily',
      date: '2024-01-15',
      author: 'Sarah Johnson',
      status: 'submitted',
      summary: 'All beds occupied, maintenance request for B-204'
    },
    {
      id: '2',
      ...
      author: 'Emma Wilson',
      status: 'reviewed',
      summary: 'Sports activities completed, cultural event planning'
    },
    {
      id: '3',
      title: 'Incident Report - Late Check-in',
      type: 'incident',
      date: '2024-01-13',
      author: 'Admin',
      status: 'submitted',
      summary: 'Three students returned after curfew'
    },
    {
      id: '4',
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Create and manage dormitory and activity reports</p>
        </div>
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Button variant="outline" className="h-auto py-4 flex flex-col items-center justify-center gap-2">
              ...
              <span className="text-xs text-muted-foreground">Routine inspection</span>
            </Button>
            <Button variant="outline" className="h-auto py-4 flex flex-col items-center justify-center gap-2">
            ...
            <Button variant="outline" className="h-auto py-4 flex flex-col items-center justify-center gap-2">
              ...
              <span className="text-xs text-muted-foreground">Comprehensive review</span>
            </Button>
            <Button variant="outline" className="h-auto py-4 flex flex-col items-center justify-center gap-2">
              <CheckCircle className="h-6 w-6" />
              <span>Activity Report</span>
              <span className="text-xs text-muted-foreground">Event participation</span>
            </Button>
          </div>
        </CardContent>
      </Card>
  ...
  return (
    <DialogContent className="sm:max-w-[700px] bg-white/90 backdrop-blur-sm">
      <DialogHeader>
        ...
        <DialogDescription>
          Fill in the details for the new report. Reports can be saved as draft or submitted immediately.
        </DialogDescription>
      </DialogHeader>
